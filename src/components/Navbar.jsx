...
export default function Navbar() {
  ...
  const isBookPage = location.pathname.includes("/Books") || location.pathname.includes("/single") || location.pathname.includes("/login") || location.pathname.includes("/Signup") || location.pathname.includes("/Cart") || location.pathname.includes("/Wish") || location.pathname.includes("/profile") || location.pathname.includes("/order");
